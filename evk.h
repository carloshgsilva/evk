...
namespace evk {
    ...
    enum class Format { Undefined, R8Unorm, R8Uint, R16Uint, R32Uint, R64Uint, BGRA8Unorm, BGRA8Snorm, RGBA8Unorm, RGBA8Snorm, RG16Sfloat, RGBA16Sfloat, RGBA16Unorm, RGBA16Snorm, R32Sfloat, RG32Sfloat, RGB32Sfloat, RGBA32Sfloat, RGBA32Sint, RGBA32Uint, D24UnormS8Uint, D32Sfloat };
    ...
    struct BLASDesc {
        ...
        Buffer aabbs;
        uint32_t aabbsCount;
        // Allow to update this BLAS after build (VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_UPDATE_BIT_KHR)
